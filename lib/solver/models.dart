...
const List<Piece> INVENTORY = [
  ...
  Piece(id: 4, cells: [Point(0, 0), Point(1, 0), Point(1, 1), Point(0, 1), Point(0, 2), Point(1, 2), Point(1, 3), Point(0, 3)], startIdx: 0, endIdx: 7, descends: false),
  ...
  Piece(id: 7, cells: [Point(0, 0), Point(0, 1), Point(0, 2), Point(0, 3), Point(-1, 1), Point(1, 1), Point(-1, 2), Point(1, 2)], startIdx: 0, endIdx: 3, descends: true),
  ...
  Piece(id: 10, cells: [Point(0, 0), Point(1, 0), Point(2, 0), Point(3, 0), Point(3, 1), Point(3, 2), Point(2, 2), Point(1, 2), Point(1, 1), Point(2, 1)], startIdx: 0, endIdx: 9, descends: true),
  Piece(id: 11, cells: [Point(0, 0), Point(0, 1), Point(0, 2), Point(1, 2), Point(1, 3), Point(1, 1)], startIdx: 0, endIdx: 4, descends: true),
  ...
  Piece(id: 13, cells: [Point(0, 0), Point(1, 0), Point(1, 1), Point(0, 1), Point(0, 2), Point(1, 2), Point(2, 2)], startIdx: 0, endIdx: 6, descends: false),
  Piece(id: 14, cells: [Point(0, 0), Point(1, 0), Point(1, -1), Point(2, -1), Point(2, 0), Point(3, 0)], startIdx: 0, endIdx: 5, descends: false),
  Piece(id: 15, cells: [Point(0, 0), Point(0, 1), Point(1, 2), Point(2, 2), Point(1, 1), Point(0, 2)], startIdx: 0, endIdx: 3, descends: false),
  Piece(id: 16, cells: [Point(0, 0), Point(1, 0), Point(1, 1), Point(0, 1), Point(0, 2), Point(1, 2)], startIdx: 0, endIdx: 5, descends: false),
